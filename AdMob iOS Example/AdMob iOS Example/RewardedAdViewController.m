...
@interface RewardedAdViewController () <GADFullScreenContentDelegate>
...
- (void)loadRewardedAd {
  ...
  [GADRewardedAd
       loadWithAdUnitID:@"ca-app-pub-8123415297019784/9110150791"
                request:request
      ...
      [AppsFlyerAdRevenueAdMob setPaidEventHandlerForTarget:[self rewardedAd] adUnitId:@"ca-app-pub-8123415297019784/9110150791" eventHandler:^(GADAdValue * _Nonnull value) {
          NSLog(@"~~>> Rewarded");
      }];
      }];
}
...
- (void)ad:(id)ad didFailToPresentFullScreenContentWithError:(NSError *)error {
  ...
  __weak RewardedAdViewController *weakSelf = self;
